document.addEventListener('DOMContentLoaded', function() {
    ...
    function hitungBiaya() {
        ...
        const biayaMakanPerOrangPerHari = 40000; // Rp 45.000 per orang per hari
        ...
        const totalBiayaWisata = biayaMasukWisataPerOrang * jumlahWisata * jumlahOrang;
        ...
        detailBiaya.innerHTML = `
            ...
            <div class="cost-item">
                <span>
                    ...
                    Rp ${formatAngka(biayaMasukWisataPerOrang)}/orang/wisata × ${jumlahWisata} wisata × ${jumlahOrang} orang
                </span>
